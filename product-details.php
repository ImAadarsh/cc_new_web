                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="slider-inner">
                                                    <img src="assets/images/shop/01.jpg" alt="full_screen-image">
                                                </div>
                                            </div>

                                            <div class="swiper-slide">
                                                <div class="slider-inner">
                                                    <img src="assets/images/shop/02.jpg" alt="full_screen-image">
                                                </div>
                                            </div>

                                            <div class="swiper-slide">
                                                <div class="slider-inner">
                                                    <img src="assets/images/shop/03.jpg" alt="full_screen-image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row ms-woo-feed">
                                        ...
                                        <div class="blog-single-two-wrapper shop">
                                            <div class="image-area">
                                                <a href="product-details.php" class="thumbnail">
                                                    <img src="assets/images/shop/05.jpg" alt="blog-image">
                                                </a>
                                            </div>
                                            <div class="inner">
                                                <span class="pre-tag">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="blog-single-two-wrapper shop">
                                            <div class="image-area">
                                                <a href="product-details.php" class="thumbnail">
                                                    <img src="assets/images/shop/06.jpg" alt="blog-image">
                                                </a>
                                            </div>
                                            <div class="inner">
                                                <span class="pre-tag">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="blog-single-two-wrapper shop">
                                            <div class="image-area">
                                                <a href="product-details.php" class="thumbnail">
                                                    <img src="assets/images/shop/07.jpg" alt="blog-image">
                                                </a>
                                            </div>
                                            <div class="inner">
                                                <span class="pre-tag">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="blog-single-two-wrapper shop">
                                            <div class="image-area">
                                                <a href="product-details.php" class="thumbnail">
                                                    <img src="assets/images/shop/08.jpg" alt="blog-image">
                                                </a>
                                            </div>
                                            <div class="inner">
                                                <span class="pre-tag">
