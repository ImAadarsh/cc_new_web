        ...
        <div class="container pb_md--100 pb_sm--80">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets/images/zoom/01.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            ...
                            <div class="bottom">
                                <div class="left">
                                    <img src="assets/images/zoom/01.png" alt="left">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets/images/zoom/02.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets/images/zoom/03.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets/images/zoom/04.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets/images/zoom/05.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="single-zoom-meeting-area">
                        <a href="zoom-details.php" class="thumbnail">
                            <img src="assets/images/zoom/06.jpg" alt="">
                        </a>
                        <div class="inner-content">
                            <div class="head">
                                <div class="single">
