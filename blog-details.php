            ...
            <div class="row g-5">
                ...
                <div class="col-xl-8 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="blog-single-post-listing details mb--0">
                        <div class="thumbnail">
                            <img src="assets/images/blog/03.jpg" alt="Business-Blog">
                        </div>
                        <div class="blog-listing-content">
                            ...
                            <div class="row g-24">
                                <div class="col-lg-6 col-md-6">
                                    <div class="thumbnail details w-100">
                                        <img class="w-100" src="assets/images/course/11.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="thumbnail details w-100">
                                        <img class="w-100" src="assets/images/course/12.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-start">
                                <div class="col-lg-5">
                                    <div class="thumbnail details mb_sm--15"><img src="assets/images/course/13.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                            ...
                            <div class="author-area reveal">
                                <div class="thumbnail details mb_sm--15">
                                    <img src="assets/images/students-feedback/01.jpg" alt="">
                                </div>
